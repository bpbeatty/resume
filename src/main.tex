...
\hypersetup{
    ...
    pdfkeywords={aws,bpmn,c++,c,camunda,developer,devops,docker,git,java,kafka,linux,os,podman,programming,python,resume,software,sysadmin,ublue},
    pdfborder=0 0 0,
...
\begin{entrylist}
  \entry
    ...
    {\begin{itemize}
        ...
        \item Implement microservice based architecture using Java Spring Boot framework.
    \end{itemize}}
  \entry
